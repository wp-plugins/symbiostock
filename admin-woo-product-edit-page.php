...
<p class="form-field _ss_mediatype_field "><input type="hidden" name="pass" value="1"><label for="_ss_modelrelease">Releases:</label><input type="checkbox" id="_ss_modelrelease" name="_ss_modelrelease" <?php if ($modelrelease) print 'checked'; ?>> Model &nbsp; <input type="checkbox" id="_ss_propertyrelease" name="_ss_propertyrelease" <?php if ($propertyrelease) print 'checked'; ?>> Property</p>
<p class="form-field _ss_mediatype_field "><input type="hidden" name="pass" value="1"><label for="_ss_exclusive">Exclusive:</label><input type="checkbox" id="_ss_exclusive" name="_ss_exclusive" <?php if ($exclusive) print 'checked'; ?>></p>
<p class="form-field _ss_mediatype_field "><input type="hidden" name="pass" value="1"><label for="_ss_editorial">Editorial:</label><input type="checkbox" id="_ss_editorial" name="_ss_editorial" <?php if ($editorial) print 'checked'; ?>></p>
