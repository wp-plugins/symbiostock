...
<tr valign="top">
						<th scope="row" class="titledesc">
							<label for="ss_default_update_metadata">Imagick PHP</label>
													</th>
						<td class="forminp forminp-number">
<?php
	$reddy = '';
...
?>
<div class="ss_envvar <?php if ($reddy) print 'ss_envimportant'; ?>"><?php if (!$reddy) print '<span class="dashicons dashicons-yes"></span>'; else print '<span class="dashicons dashicons-flag"></span>'; ?><?php print $cmd; ?></div> &nbsp; <span class="description">Imagick is an advanced image manipulation module for PHP and Linux that is used heavily by Symbiostock. <a href="http://www.symbiostock.org/docs/installing-symbiostock/" target="_blank">Documentation</a>. <?php if ($reddy) print '<b>In the absence of Imagick, Symbiostock will attempt to use the base GD library built into PHP. This provides limited functionality that will only work with JPEG images.</b>'; ?></span>
</td>
					</tr>
<tr valign="top">
						<th scope="row" class="titledesc">
...
?>
<div class="ss_envvar <?php if ($reddy) print 'ss_envimportant'; ?>"><?php if (!$reddy) print '<span class="dashicons dashicons-yes"></span>'; else print '<span class="dashicons dashicons-flag"></span>'; ?><?php print $cmd; ?></div> &nbsp; <span class="description">The shell_exec command is used to read and write metadata. Without this enabled, you will not be able to write metadata to your media and reading may be limited. <?php if ($reddy) print '<b>You currently cannot write metadata to images. Please contact your web-host regarding enabling this.</b>'; ?></span>
<style>
.ss_envvar {
