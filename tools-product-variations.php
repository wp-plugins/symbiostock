...
function ss_apply_default_licenses_to_product($postid) {
	...
	$args = array( 'post_type' => 'product_variation', 'post_parent'=> $postid , 'posts_per_page'=> 99999999);
	$myposts = get_posts($args);
	$currentvariations = array();
	foreach ( $myposts as $currvariation ) {
		$currentvariations[] = get_post_meta( $currvariation->ID, 'attribute_pa_license', true );
	}
